...
class TermCondText extends Component {
  state = {};
  render() {
    ...
    return (
      <div>
        ...
        Welcome to <span style={{ color: "#ff6a00" }}>COMENTA Y GANA</span>!
        <p>
          These terms and conditions outline the rules and regulations for the
          use of COMENTA Y GANA, located at comentaygana.com.
        </p>
        <p>
        ...
        <p>
          ...
          Website Name Sell, rent or sub-license material from Website Name
          Reproduce, duplicate or copy material from Website Name Redistribute
          content from Website Name This Agreement shall begin on the date
          hereof. Parts of this website offer an opportunity for users to post
          ...
          posting of and/or appearance of the Comments on this website. Company
          Name reserves the right to monitor all Comments and to remove any
          Comments which can be considered inappropriate, offensive or causes
          breach of these Terms and Conditions. You warrant and represent that:
          ...
          copyright, patent or trademark of any third party; The Comments do not
          ...
          commercial activities or unlawful activity. You hereby grant Company
          Name a non-exclusive license to use, reproduce, edit and authorize
        ...
        <p>
          ...
          fundraising groups which may not hyperlink to our Web site. These
          ...
          absence of Company Name; and (d) the link is in the context of general
          ...
          in paragraph 2 above and are interested in linking to our website, you
          must inform us by sending an e-mail to Company Name. Please include
          ...
          may hyperlink to our Website as follows: By use of our corporate name;
          or By use of the uniform resource locator being linked to; or By use
          of any other description of our Website being linked to that makes
          sense within the context and format of content on the linking party's
          site. No use of Company Name's logo or other artwork will be allowed
